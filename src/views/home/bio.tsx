...
export const Bio = () => {
  return (
    <Box p="21px" bg="white" width="50%" justifyContent="space-around" alignItems="center" sx={{ borderRadius: 10 }}>
      ...
      <Text mt={4} lineHeight={1.5} color="darkGrey">
        ...
        développement écoresponsables, orientée performance et SEO (Azinove). J&apos;ai également travaillé pour la
